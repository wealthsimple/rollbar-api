describe RollbarApi::Project do
  describe ".add" do
    it "adds a Project to list" do
      ...
      RollbarApi::Project.add("my-project", "my-token")
  ...
  describe ".find" do
    before { RollbarApi::Project.add("my-project", "my-token") }
  ...
  describe ".all" do
    it "returns all Projects" do
      ...
      RollbarApi::Project.add("my-project", "token1")
      RollbarApi::Project.add("my-project-2", "token2")
